		...
		<div class="row align-items-center min-vh-100 justify-content-center">
			<div class="col-6">
				<div class="card bg-dark text-white border">
					...
					<div class="card-body">
					<form method="post" action="<?php url('connexion-post'); ?>">
						<p>
							<input type="text" class="form-control bg-dark text-white" name="user_name" placeholder="Username">
						</p>
						<p>
							<input type="password" class="form-control bg-dark text-white"  name="user_password" placeholder="Password">
						</p>
